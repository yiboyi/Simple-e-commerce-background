    ...
    <el-card>
      ...
      <el-tabs v-model="activeName" @tab-click="handleTabClick">
        <el-tab-pane label="动态参数" name="many">
          <el-button sizi="mini" type="primary" :disabled="isBtnDisabled" @click="addDialogVisible = true">添加参数</el-button>
          <!-- 动态参数表格 -->
        ...
        <el-tab-pane label="静态属性" name="only">
          <el-button sizi="mini" type="primary" :disabled="isBtnDisabled" @click="addDialogVisible = true">添加属性</el-button>
          <!-- 静态参数表格 -->
  ...
  methods: {
    ...
    EditParams(attrId) {
      this.$refs.EditFormRef.validate(async valid => {
        ...
        if (res.meta.status !== 200) {
          return this.$message.error('修改动态参数或者静态属性失败!')
        }
